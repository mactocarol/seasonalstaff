               ...
               <div class="box">
                <div class="box-header">
                  <h3 class="box-title">List Industry</h3>
                      <button class="btn btn-danger pull-right"><a href="<?php echo site_url('add-Industry'); ?>" style="color:white">Add Industry</a></button>&nbsp;
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                          ...
                          <?php if(isset($industrys)) {
                            ...
                            <tr>
                               ...
                               <td> <?php echo (date('Y',strtotime($row['created_date'])) != '1970') ? date('d M Y',strtotime($row['created_date'])) : 'NA'; ?> </td>
                                ...
                                <td>
                                  <a href="<?php echo site_url(); ?>edit-Industry/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
...
var user_id = $('#userDel').val();
        $.ajax({
            url: site_url +"Industries/Industry/delete/"+user_id,
            type: "POST",
            data: {
                user_id: user_id,
             ...
             success: function (msg) {
                if (msg) {
                   ...
                   window.location.href = site_url+"Industry-list";
