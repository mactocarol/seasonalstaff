        ...
        <section class="col-lg-12 connectedSortable">
               ...
               <div class="box">
                ...
                <div class="box-body">
                  ...
                  <form role="form" id="Industry_form" name="" method="post" action="<?php echo site_url('add-Industry'); ?>">
                        ...
                        <!-- text input -->
                           ...
                           <section class="col-lg-12 connectedSortable">
                             ...
                             <div class="box-footer">
                                ...
                                <input type="submit" class="btn btn-primary" name="Update_profile" value="Add Industry">
