            ...
            <section class="col-lg-12 connectedSortable">
               ...
               <div class="box">
                <div class="box-header">
                  <h3 class="box-title">List Add On's</h3>
                      <button class="btn btn-danger pull-right"><a href="<?php echo site_url('add-Package'); ?>" style="color:white">Add Add On's</a></button>&nbsp;
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                          ...
                          <?php if(isset($packages)) {
                            ...
                            <tr>
                                ...
                                <td> <?php
                                 ...
                                 <td><i class="fa fa-dollar"></i> <?php
                                 echo isset($row['price']) ? $row['price'] : '';
                               ...
                               <td> <?php echo (date('Y',strtotime($row['created_date'])) != '1970') ? date('d M Y',strtotime($row['created_date'])) : 'NA'; ?> </td>
                                ...
                                <td>
                                  <a href="<?php echo site_url(); ?>edit-Package/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
...
var user_id = $('#userDel').val();
        $.ajax({
            url: site_url +"Packeges/Package/delete/"+user_id,
            type: "POST",
            data: {
                user_id: user_id,
             ...
             success: function (msg) {
                if (msg) {
                   ...
                   window.location.href = site_url+"Package-list";
