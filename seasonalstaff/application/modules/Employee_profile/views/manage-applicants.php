...
<div class="breadcrumb text-center">
    ...
    <ul><li><a href="#">home</a></li><li>Manage Applicants</li></ul>
    </div>
</div>
...
var job_id='<?php echo $this->uri->segment(2); ?>';
        $.ajax({
            url: site_url +"Employee_profile/Profile/deleteapplys/"+id,
            type: "POST",
            data: {
               id: id,job_id:job_id,
            },
             success: function (msg) {
                if (msg) {
               window.location.href = site_url+"manage-applicants/";
...
var job_id='<?php echo $this->uri->segment(2); ?>';
$.ajax({
            url: site_url +"Employee_profile/Profile/userapplystatuss/",
            type: "POST",
            data: {
