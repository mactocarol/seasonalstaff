            ...
            <section class="col-lg-12 connectedSortable">
               ...
               <div class="box">
                <div class="box-header">
                  <h3 class="box-title">List Privacy Policy</h3>
                          ...
                          <?php if(isset($records)) {
                            ...
                            <tr>
                               ...
                               <td> <?php echo (date('Y',strtotime($row['create_dt'])) != '1970') ? date('d M Y',strtotime($row['create_dt'])) : 'NA'; ?> </td>
                                ...
                                <td>
                                  <a href="<?php echo site_url(); ?>Admin/editprivacypolicy/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>                                                                   
                                </td> 
                            </tr>                          
                    <?php  } }?>                      
