            ...
            <section class="col-lg-12 connectedSortable">
               ...
               <div class="box">
                <div class="box-header">
                  <h3 class="box-title">List Skill</h3>
                      <button class="btn btn-danger pull-right"><a href="<?php echo site_url('add-Skill'); ?>" style="color:white">Add Skill</a></button>&nbsp;
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    ...
                    <tbody>
                          <?php if(isset($skills)) {
                            ...
                            <tr>
                                <td><?= ++$count; ?></td>
                                <td> <?php
                                 echo isset($row['skills']) ? $row['skills'] : '';

                                // if(!empty($row['skills'])){

                                //   $explode = explode(',', $row['skills']);
                               ...
                               <td> <?php echo (date('Y',strtotime($row['created_date'])) != '1970') ? date('d M Y',strtotime($row['created_date'])) : 'NA'; ?> </td>
                                ...
                                <td>
                                  <a href="<?php echo site_url(); ?>edit-Skill/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
...
var user_id = $('#userDel').val();
        $.ajax({
            url: site_url +"Skills/Skill/delete/"+user_id,
            type: "POST",
            data: {
                user_id: user_id,
             ...
             success: function (msg) {
                if (msg) {
                   ...
                   window.location.href = site_url+"Skill-list";
