  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Staff Plan Price</li>
      </ol>
    </section>
            ...
            <section class="col-lg-12 connectedSortable">
               ...
               <div class="box">
                <div class="box-header">
                  <h3 class="box-title">List Staff Plan Price</h3>
                ...
                <div class="box-body">
                 <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tr>
                      ...
                      <!-- <th>Plan Name</th> -->
                      <th>Amount</th>
					    <th>Find work by location</th> 
						<th>Find work by Month</th>
                        <th>Find work that suits your needs</th>						
						<th>Make a favourites list</th>
						<th>Track your applications</th>  
						<th>Have your own profile</th> 
						<th>Easy application process.</th> 						 
						<th>More features</th>
                       <th>Created Date</th>
                          ...
                          <?php if(isset($records)) {
                            ...
                            <tr>
                               ...
                               <td> <?php echo (date('Y',strtotime($row['created_at'])) != '1970') ? date('d M Y',strtotime($row['created_at'])) : 'NA'; ?> </td>
                                ...
                                <td>
                                  <a href="<?php echo site_url(); ?>Plans/Plan/editstaff/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
