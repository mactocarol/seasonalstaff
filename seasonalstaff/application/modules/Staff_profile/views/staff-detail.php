						...
						//print_r($todate); die;
							...
							<div class="staff_service_row">
								<div class="st_inner_part">
									...
									<p><b>Description</b> - <?php echo $t11['data3']; ?></p>
									<?php 
									$ii = $t11['data2']; 
									if($ii==""){
									$ii ='null';	
									...
									?>
									<p><b>Industry</b> - <?php  foreach($query->result() as $sk) { echo $sk->name; }  ?></p>
				...
				<div class="col-md-4 col-sm-12">	
					<div class="staff_sidebar">
						<div class="staff_widget">						
							...
							<div class="staff_wgt_title">Work Seekers Details</div>
...
<div class="popup_wrapper" id="cv_popup">
      <div class="popup_dialog">
        <div class="popup_content">
          ...
          <form  method="post" action="<?php echo site_url('Welcome/mailsendstaff'); ?>">
...
<script>
 $(function() 
  {
   jQuery('.datepicker').datepicker('setDate', '<?php  
