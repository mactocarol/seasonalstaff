  ...
  <!-- Dashboard content Start -->
            ...
            <div class="col-xl-9 col-lg-8 col-md-12 col-sm-12">
                <div class="dashboard_content_part">					
					<center><span id="hh"><h5><?php if(isset($userdeatil[0]->first_name)){ echo $userdeatil[0]->first_name; } ?> <?php if(isset($userdeatil[0]->last_name)){ echo $userdeatil[0]->last_name; } ?></h5></center>	
		                                ...
		                                <div class="bottom_chat_form">
											...
											<input type="hidden" name="rid1" id="rid1">
		                                		...
		                                		<div class="chat_form" id="chatf">
                                					...
                                					<textarea name="msg" id="msg" placeholder="Type a Message" rows="3"></textarea>											
...
function edValueKeyPress()
{
   var edValue = document.getElementById("usersearch");	
	var surid = edValue.value;   
		$.ajax({		
			url:'<?php echo base_url(); ?>Staff_profile/Staffprofile/getmsglist',			
			type: 'POST',
			data:{'surid':surid},
...
function user(rid)
	...
	$("#cc"+ct).addClass("active");			
     //alert(rid);
		$.ajax({		
			url:'<?php echo base_url(); ?>Staff_profile/Staffprofile/getmeassage',			
			type: 'POST',
			data:{'rid':rid},
			success: function(response){ 
			//alert(response);
...
function msend()
   ...
   if(document.getElementById("msg").value!=''){	
	...
	$.ajax({		
			url:'<?php echo base_url(); ?>Staff_profile/Staffprofile/sendmsg',
			type: 'POST',
