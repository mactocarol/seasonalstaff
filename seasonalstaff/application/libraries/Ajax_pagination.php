...
class Ajax_pagination{
    ...
    var $last_link       = '&#187;';
    var $uri_segment     = 3;
    var $full_tag_open   = '<div class="search_pagination"><nav aria-label="Page navigation example"><ul class="pagination"><li class="page-item">';
    var $full_tag_close  = '</li></ul></nav></div>';
    var $first_tag_open  = '';
    var $first_tag_close = '&nbsp;';
    var $last_tag_open   = '&nbsp;';
    var $last_tag_close  = '';
    ...
    function getAJAXlink($count, $text) {
        ...
        return '<li><a href="javascript:void(0);"' . $this->anchor_class . ' onclick="'.$this->link_func.'('.$pageCount.')" class="page-link">'. $text .'</a></li>';
    }
}
